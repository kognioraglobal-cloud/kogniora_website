      ...
      <div className="corp-body">
        ...
        <div className="value-band" style={{marginBottom:44}}>
          ...
          <div className="value-grid">
            {[
              ...
              { icon:'🌍', title:'Global Delivery', desc:'Our certified trainer network spans 18+ countries. We deliver wherever your teams are, at your offices or our venues.' },
              { icon:'📜', title:'Accredited Programmes', desc:'All courses are aligned with international standards. Real credentials, real value.' },
              ...
              {cats.map(c => (
                <Link key={c.id} href={`/courses/${c.slug}`} className="cat-course-card">
                  ...
                  <div className="cat-course-meta">
                    <span className="cat-course-days">{c.duration_days || 2} day</span>
        ...
        <div className="process-section">
          ...
          <div className="process-steps">
            {[
              ...
              { n:2, label:'Consultation',  desc:'Our team reviews your objectives and recommends the most suitable training solution' },
              ...
              { n:5, label:'Certification', desc:'Participants receive certificates of completion' },
            ].map(s => (
        ...
        <div className="cta-band">
          <div>
            ...
            <p>Share your training requirements with us, and our team will recommend a programme tailored to your goals, timeline, and budget.</p>
          </div>
